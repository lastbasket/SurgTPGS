...
def render_flow(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, 
    ...
    if include_feature:
        opacity_lang = pc._language_opa
        opacity_lang_deform = opacity_lang[deformation_point]
        opacity_lang_final = torch.zeros_like(opacity_lang)
        opacity_lang_final[deformation_point] = opacity_lang_deform
        ...
        return {"render": rendered_image,
                "render_lang": rendered_language_feature,
                "depth": depth,
